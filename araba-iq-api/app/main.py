...
from app.api.routes import brands, cars, garage, health, market, recommendations, scoring, segments, vehicle_models, sahibinden
...
app.include_router(garage.router, prefix=settings.api_v1_prefix)
